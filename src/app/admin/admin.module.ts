...
import { ProblemComponent, AddProblem, EditProblem } from './problem/problem.component';
@NgModule({
  ...
  exports: [],
  providers: [],
  entryComponents: [QuestionDialog, AddQuestion, DialogQ, UpdateDialog, NoteCom, EditExaminee, EditQuestion,AddProblem,EditProblem]
})
